...
const Myself = () => {
    return (
        <div>
            <div>
                <h1 className='mt-[30px] md:ml-[25px] ml-[25px] md:font-medium font-semibold md:text-[40px] text-[#1e275f] text-[30px] md:w-auto w-[350px] text-center hidden md:block'>Инструменты с которыми я научился работать:</h1>
            ...
            <div className='md:w-[900px] w-[385px] flex flex-wrap gap-[10px] mt-[30px] md:ml-[25px] ml-[5px] md:items-center justify-center'>
